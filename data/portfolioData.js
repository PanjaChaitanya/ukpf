export const portfolioData = {
  ...
  skills: [
    ...
    {
      category: "Regulatory and Collaboration",
      proficiency: 91,
      items: [
  ...
  experience: [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Created ADaM datasets for safety and efficacy analyses with end-to-end validation.",
        "Maintained SDTM mapping quality across data refresh cycles and edit-check listings.",
        "Produced high-priority ad hoc outputs for project and client decision support.",
      ],
    },
    {
      id: "accenture",
      ...
      highlights: [
        ...
        "Programmed ISS and CSR-ready TLF packages in PDF and RTF formats.",
        "Executed edit checks and issue tracking workflows to support data management resolution.",
        "Contributed to CRF annotation and macro-driven reporting automation.",
      ],
    },
    {
      id: "icmr",
      ...
      highlights: [
        "Conducted nutrient, anti-nutrient, and bioactive phytonutrient determination studies.",
      ],
    },
    {
      id: "ccmb",
